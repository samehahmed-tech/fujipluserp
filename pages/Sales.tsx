          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500">
            <thead className="text-xs text-gray-700 uppercase bg-gray-50">
              <tr>
                ...
                <th scope="col" className="px-6 py-3">{translations.customer}</th>
            ...
            <tbody>
              {filteredSales.map((sale) => (
                <tr key={sale.id} className="bg-white border-b hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">{sale.total.toFixed(2)} AED</td>
                  <td className="px-6 py-4"><StatusBadge status={sale.status} /></td>
                  <td className="px-6 py-4 text-right">
                    <a href="#" className="font-medium text-sky-600 hover:underline">View</a>
                  </td>
                </tr>
              ))}
            </tbody>
