...
export const ItemsManagement: React.FC = () => {
    ...
    const totalQuantity = useMemo(() => {
        // FIX: The type of `warehouseStock` was inferred as `unknown`. Added explicit type to fix this.
    ...
    return (
        <PageLayout pageTitle={translations.items_management}>
            <div className="flex flex-col h-full bg-gray-50 text-gray-800">
                ...
                <div className="flex items-center justify-between p-2 bg-white border-b border-gray-200 flex-wrap gap-2 shadow-sm">
                    <div className="flex items-center gap-2">
                         <h2 className="text-xl font-bold text-green-600 px-4">{translations.items_management}</h2>
                    </div>
                    <div className="flex items-center gap-2">
